...
const AddEstablishmentScreen = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.light }} edges={['top', 'bottom']}>
      <HeaderComponent title={t('navigation.establishment.new')} />
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: PADDING.p10, paddingHorizontal: PADDING.p05, paddingTop: PADDING.p05 }}>
        ...
        <Text style={{ color: COLORS.dark, fontSize: 15, lineHeight: 22, textAlign: 'center', marginBottom: PADDING.p05, paddingHorizontal: PADDING.p05 }}>{t('navigation.establishment.publishing_info')}</Text>
